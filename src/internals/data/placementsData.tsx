...
export const columns: GridColDef[] = [
  ...
  {
    field: 'nextAction', headerName: 'Next Action', flex: 1, minWidth: 140
  },
  {
    field: 'nextActionDate', headerName: 'Next Action Date', flex: 1, minWidth: 130
  },
  { field: 'nextStepOwner', headerName: 'Next Step Owner', flex: 1, minWidth: 140 },
  { field: 'uwName', headerName: 'UW Name', flex: 1, minWidth: 120 },
  { field: 'specificCoverageType', headerName: 'Specific Coverage Type', flex: 1, minWidth: 160 },
  { field: 'accountHandlerName', headerName: 'Account Handler Name', flex: 1, minWidth: 150 },
  { field: 'gpsName', headerName: 'GPS Name', flex: 1, minWidth: 120 },
  { field: 'accountExecutive', headerName: 'Account Executive', flex: 1, minWidth: 150 },
  { field: 'dptName', headerName: 'DPT Name', flex: 1, minWidth: 120 },
  {
    field: 'outstandingItems',
    headerName: 'Outstanding Items',
    flex: 2,
    minWidth: 200,
    renderCell: (params) => {
      // Example logic: if reinsuranceCession is 0, no need for RA attachments
      const { reinsuranceCession = 0, raAttachments = false } = params.row;
      if (reinsuranceCession === 0) {
        return <span>No outstanding items</span>;
      }
      if (!raAttachments) {
        return <span>RA Attachments Required</span>;
      }
      return <span>All items complete</span>;
    },
  },
];

...
export default function CompanyLicensingInformation() {
        ...
        <Box component="main" sx={{}}>
            <Stack spacing={2}>
                <Grid container spacing={2}>
                    <Grid size={3}>
                        <Stack spacing={2}>
                            <InputLabel>Licensing Authority Name</InputLabel>
                            <TextField
                                fullWidth
                                value={licensingInfo.authorityName}
                                onChange={(e) => setLicensingInfo({ ...licensingInfo, authorityName: e.target.value })}
                            />
                        </Stack>
                    </Grid>
                    <Grid size={3}>
                        <Stack spacing={2}>
                            ...
                            <TextField
                                ...
                                onChange={(e) => setLicensingInfo({ ...licensingInfo, licenseNumber: e.target.value })}
                            />
                        </Stack>
                    </Grid>
                    <Grid size={3}>
                        <Stack spacing={2}>
                            <InputLabel>License Authority Website</InputLabel>
                            <TextField
                                fullWidth
                                value={licensingInfo.authorityWebsite}
                                onChange={(e) => setLicensingInfo({ ...licensingInfo, authorityWebsite: e.target.value })}
                            />
                        </Stack>
                    </Grid>
                    <Grid size={12}>
                        <Stack spacing={2}>
                            <InputLabel>Attachments for Licensing Information</InputLabel>

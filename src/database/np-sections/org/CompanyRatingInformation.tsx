...
export const CompanyRatingInformation = () => {
    const [rating, setRating] = useState('');
    const [ratingOutlook, setRatingOutlook] = useState('');
                ...
                <Grid container spacing={2} direction="row">
                    <Grid size={3}>
                        ...
                        >
                            ...
                            {[
                                'A++', 'A+', 'A', 'A-', 'B++', 'B+', 'B', 'B-', 'C++', 'C+', 'C', 'C-', 'D', 'E', 'F', 'S', 'Not Rated'
                            ].map(option => (
                    ...
                    <Grid size={3}>
                        <InputLabel>Rating Outlook</InputLabel>
                        <Select
                            value={ratingOutlook}
                            onChange={(e) => setRatingOutlook(e.target.value)}
                            displayEmpty
                            input={<OutlinedInput />}
                            fullWidth
                        >
                            <MenuItem value="" disabled>
                                <Typography>Select Outlook</Typography>
                            </MenuItem>
                            {['Positive', 'Stable', 'Negative'].map(option => (
                                <MenuItem key={option} value={option}>{option}</MenuItem>
                            ))}
                        </Select>
                    </Grid>
                    ...
                    <Grid size={3}>
                        <InputLabel>Rating Date</InputLabel>
                        <TextField
                            type="date"
                            fullWidth
                            value={ratingDate}
...
export default CompanyRatingInformation;
